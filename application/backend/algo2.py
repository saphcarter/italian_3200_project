...
def compareFiles(path1, path2):
    ...
    #normalise db
    spectogram_filter1 = librosa.util.normalize(spectogram_filter1, axis=1)
    ...
    #normalise intensity (db)
    spectogram_filter2 = librosa.util.normalize(spectogram_filter2, axis=1)
    ...
    threshold = 0.1
    blob_image1 = blobs1 > threshold
    blob_image2 = blobs2 > threshold
    ...
    similarity_score = ssim(blob_image1, blob_image2, data_range=dataRange)
